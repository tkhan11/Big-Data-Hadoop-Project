...
public class TotalTransactionsPerCustomerMapred extends javax.swing.JFrame {
    public TotalTransactionsPerCustomerMapred() {
        initComponents();
    }
    ...
    private void initComponents() {
		...
		setTitle("Total Transactions Per Customer");
    ...
    private void ExecutevarActionPerformed(java.awt.event.ActionEvent evt) {
		String args[]={"Superstoredata/superstore.csv","Superstoredata/outputdir/TotalTransactionsPerCustomer"};              
			try{
				TotalTransactionsPerCustomer.Driver(args); 	   
			} catch(Exception e){}
    ...
    private void savevarActionPerformed(java.awt.event.ActionEvent evt) {
		try{
			...
			FileOutputStream fout=new FileOutputStream("/home/cloudera/Desktop/Reports/TotalTransactionsPerCustomer");
			BufferedReader br=new BufferedReader(new InputStreamReader(fs.open(new Path("Superstoredata/outputdir/TotalTransactionsPerCustomer/part-r-00000/"))));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TotalTransactionsPerCustomerMapred.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
