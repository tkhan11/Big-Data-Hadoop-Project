...
public class AvgTotSalesPurchsePricePerCustMapred extends javax.swing.JFrame {
    public AvgTotSalesPurchsePricePerCustMapred() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Average Total Sales Per Customer ");
    ...
    private void ExecutevarActionPerformed(java.awt.event.ActionEvent evt) {
		String args[]={"Superstoredata/customer.csv","Superstoredata/transaction.csv","Superstoredata/outputdir/AvgTotSalesPurchsePricePerCustomer"};
                   
		try{
				AvgTotSalesPurchsePricePerCust.Driver(args); 	   
		} catch(Exception e){}
    ...
    private void savevarActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try{
			...
			FileOutputStream fout=new FileOutputStream("/home/cloudera/Desktop/Reports/AvgTotSalesPurchsePricePerCustomer");
			BufferedReader br=new BufferedReader(new InputStreamReader(fs.open(new Path("Superstoredata/outputdir/AvgTotSalesPurchsePricePerCustomer/part-r-00000/"))));
    ...
    public static void main(String args[]) {
		...
		try {
            ...
            java.util.logging.Logger.getLogger(AvgTotSalesPurchsePricePerCustMapred.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
