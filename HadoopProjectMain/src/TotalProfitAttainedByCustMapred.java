...
public class TotalProfitAttainedByCustMapred extends javax.swing.JFrame {
    public TotalProfitAttainedByCustMapred() {
        initComponents();
    }
    ...
    private void initComponents() {
		...
		setTitle("Total Profit Attained");
    ...
    private void ExecutevarActionPerformed(java.awt.event.ActionEvent evt) {
		String args[]={"Superstoredata/superstore.csv","Superstoredata/outputdir/TotalProfitAttainedByCustomer"};
                   
			try{
				 TotalProfitAttainedByCustomer.Driver(args); 	   
			} catch(Exception e){}
    ...
    private void savevarActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try{
			...
			FileOutputStream fout=new FileOutputStream("/home/cloudera/Desktop/Reports/TotalProfitAttainedByCustomer");
			BufferedReader br=new BufferedReader(new InputStreamReader(fs.open(new Path("Superstoredata/outputdir/TotalProfitAttainedByCustomer/part-r-00000/"))));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TotalProfitAttainedByCustMapred.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
