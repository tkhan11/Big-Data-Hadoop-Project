...
public class CategoryWiseTotalSalesMapred extends javax.swing.JFrame {
    public CategoryWiseTotalSalesMapred() {
        initComponents();
    }
    ...
    private void initComponents() {
		...
		setTitle("Category Wise Total Sales");
    ...
    private void ExecutevarActionPerformed(java.awt.event.ActionEvent evt) {
		String args[]={"Superstoredata/superstore.csv","Superstoredata/outputdir/CategoryWiseTotalSalesPrice"};
                   
			try{
				 CategoryWiseTotalSalesPrice.Driver(args); 	   
			} catch(Exception e){}
    ...
    private void savevarActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try{
			...
			FileOutputStream fout=new FileOutputStream("/home/cloudera/Desktop/Reports/CategoryWiseTotalSalesPrice");
			BufferedReader br=new BufferedReader(new InputStreamReader(fs.open(new Path("Superstoredata/outputdir/CategoryWiseTotalSalesPrice/part-r-00000/"))));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(CategoryWiseTotalSalesMapred.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
