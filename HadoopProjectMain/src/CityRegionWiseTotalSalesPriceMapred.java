...
public class CityRegionWiseTotalSalesPriceMapred extends javax.swing.JFrame {
    public CityRegionWiseTotalSalesPriceMapred() {
        initComponents();
    }
    ...
    private void initComponents() {
		...
		setTitle("City Wise Total Sales");
    ...
    private void ExecutevarActionPerformed(java.awt.event.ActionEvent evt) {
		String args[]={"Superstoredata/superstore.csv","Superstoredata/outputdir/CityRegionWiseTotalSalesPrice"};
                   
			try{
				 CityRegionWiseTotalSalesPrice.Driver(args); 	   
			} catch(Exception e){}
	...
	try{
			...
			FileOutputStream fout=new FileOutputStream("/home/cloudera/Desktop/Reports/CityRegionWiseTotalSalesPrice");
			BufferedReader br=new BufferedReader(new InputStreamReader(fs.open(new Path("Superstoredata/outputdir/CityRegionWiseTotalSalesPrice/part-r-00000/"))));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(CityRegionWiseTotalSalesPriceMapred.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
