...
public class SubCategoryWiseTotalSalesMapred extends javax.swing.JFrame {

    public SubCategoryWiseTotalSalesMapred() {
        initComponents();
    }
    ...
    private void initComponents() {
		...
		setTitle("Sub Category Wise Total Sales");
    ...
    private void ExecutevarActionPerformed(java.awt.event.ActionEvent evt) {
		String args[]={"Superstoredata/superstore.csv","Superstoredata/outputdir/SubCategoryWiseTotalSalesPrice"};
                   
			try{
				 SubCategoryWiseTotalSalesPrice.Driver(args); 	   
			} catch(Exception e){}
	...
	try{
			...
			FileOutputStream fout=new FileOutputStream("/home/cloudera/Desktop/Reports/SubCategoryWiseTotalSalesPrice");
			BufferedReader br=new BufferedReader(new InputStreamReader(fs.open(new Path("Superstoredata/outputdir/SubCategoryWiseTotalSalesPrice/part-r-00000/"))));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(SubCategoryWiseTotalSalesMapred.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
