...
public class SegmentWiseTotalSalesMapred extends javax.swing.JFrame {

    public SegmentWiseTotalSalesMapred() {
        initComponents();
    }
    ...
    private void initComponents() {
		...
		setTitle("Segment Wise Total Sales");
    ...
    private void ExecutevarActionPerformed(java.awt.event.ActionEvent evt) {
		String args[]={"Superstoredata/superstore.csv","Superstoredata/outputdir/SegmentWiseTotalSalesPrice"};
                   
			try{
				 SegmentWiseTotalSalesPrice.Driver(args); 	   
			} catch(Exception e){}
    ...
    private void savevarActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try{
			...
			FileOutputStream fout=new FileOutputStream("/home/cloudera/Desktop/Reports/SegmentWiseTotalSalesPrice");
			BufferedReader br=new BufferedReader(new InputStreamReader(fs.open(new Path("Superstoredata/outputdir/SegmentWiseTotalSalesPrice/part-r-00000/"))));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(SegmentWiseTotalSalesMapred.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
