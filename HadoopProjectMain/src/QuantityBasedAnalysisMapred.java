...
public class QuantityBasedAnalysisMapred extends javax.swing.JFrame {
    public QuantityBasedAnalysisMapred() {
        initComponents();
    }
    ...
    private void initComponents() {
		...
		setTitle("Quantity Based Analysis");
    ...
    private void ExecutevarActionPerformed(java.awt.event.ActionEvent evt) {
		String args[]={"Superstoredata/superstore.csv","Superstoredata/outputdir/QuantityBasedAnalysis"};
                   
			try{
				 QuantityBasedAnalysis.Driver(args); 	   
			} catch(Exception e){}
    ...
    private void savevarActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try{
			...
			FileOutputStream fout=new FileOutputStream("/home/cloudera/Desktop/Reports/QuantityBasedAnalysis");
			BufferedReader br=new BufferedReader(new InputStreamReader(fs.open(new Path("Superstoredata/outputdir/QuantityBasedAnalysis/part-r-00000/"))));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(QuantityBasedAnalysisMapred.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
