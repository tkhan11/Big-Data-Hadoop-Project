...
public class CustomerTotalPurchasepricemapred extends javax.swing.JFrame {
    public CustomerTotalPurchasepricemapred() {
        initComponents();
    }
    ...
    private void initComponents() {
		...
		setTitle("Customer Total Purchase Price");
    ...
    private void ExecutevarActionPerformed(java.awt.event.ActionEvent evt) {
		String args[]={"Superstoredata/superstore.csv","Superstoredata/outputdir/CustTotalPurchasePrice"};
                   
			try{
				 CustTotalPurchasePrice.Driver(args); 	   
			} catch(Exception e){}
    ...
    private void ShowvarActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try{
			...
			BufferedReader br=new BufferedReader(new InputStreamReader(fs.open(new Path("Superstoredata/outputdir/CustTotalPurchasePrice/part-r-00000/"))));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerTotalPurchasepricemapred.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
