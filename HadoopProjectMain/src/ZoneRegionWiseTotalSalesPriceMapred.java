...
public class ZoneRegionWiseTotalSalesPriceMapred extends javax.swing.JFrame {
    public ZoneRegionWiseTotalSalesPriceMapred() {
        initComponents();
    }
    ...
    private void initComponents() {
		...
		setTitle("Zone Wise Total Sales");
    ...
    private void ExecutevarActionPerformed(java.awt.event.ActionEvent evt) {
		String args[]={"Superstoredata/superstore.csv","Superstoredata/outputdir/ZoneRegionWiseTotalSalesPrice"};
			try{
				 ZoneRegionWiseTotalSalesPrice.Driver(args); 	   
			} catch(Exception e){}
    ...
    private void savevarActionPerformed(java.awt.event.ActionEvent evt) {
		try{
			...
			FileOutputStream fout=new FileOutputStream("/home/cloudera/Desktop/Reports/ZoneRegionWiseTotalSalesPrice");
			BufferedReader br=new BufferedReader(new InputStreamReader(fs.open(new Path("Superstoredata/outputdir/ZoneRegionWiseTotalSalesPrice/part-r-00000/"))));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(ZoneRegionWiseTotalSalesPriceMapred.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
